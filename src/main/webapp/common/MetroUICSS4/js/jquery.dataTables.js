...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="input-filter"/>';
	...
	function _fnSortListener ( settings, colIdx, append, callback )
	{
		...
		_fnReDraw( settings );
		_fnCallbackFire( settings, 'aoSortCallBack', 'afterSort', [settings] );
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			//加入排序回调函数
			_fnCallbackReg( oSettings, 'aoSortCallBack',       oInit.fnSortCallBack,     'user' );
